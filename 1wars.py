...
#cl = LineClient()
cl = LineClient(authToken='EvQpwTnEQeamMHzgqN96.Quylp3VzyQ3MyIa1e9BlrG.K0jctEBoG57AxuNaXz+SRvtdYPkr7BX+uhhrE2C5yOI=')
...
poll = LinePoll(cl)
call = cl
creator = ["ua9460b3f7bd962ade662203513d6cb46"]
owner = ["ua9460b3f7bd962ade662203513d6cb46"]
admin = ["ua9460b3f7bd962ade662203513d6cb46"]
staff = ["ua9460b3f7bd962ade662203513d6cb46"]
mid = cl.getProfile().mid
KAC = [cl]
#ABC = [ki,kk,kc,kg,kj,km]
Bots = [mid]
Wars = admin + staff
...
warsProfile = cl.getProfile()
myProfile["displayName"] = warsProfile.displayName
myProfile["statusMessage"] = warsProfile.statusMessage
myProfile["pictureStatus"] = warsProfile.pictureStatus
...
with open('creator1.json', 'r') as fp:
    creator = json.load(fp)
with open('owner.json', 'r') as fp:
    owner = json.load(fp)
with open('admin1.json', 'r') as fp:
    admin = json.load(fp)    
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        if kz.getGroup(op.param1).preventedJoinByTicket == False:
                                                            if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                                                ks.reissueGroupTicket(op.param1)
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        group = ks.getGroup(op.param1)
                                                        gMembMids = [contact.mid for contact in group.invitee]
                                                        for _mid in gMembMids:
                                                            random.choice(ABC).cancelGroupInvitation(op.param1,[_mid])
                                                    except:
                                                        try:
                                                            group = kz.getGroup(op.param1)
                                                            gMembMids = [contact.mid for contact in group.invitee]
                                                            for _mid in gMembMids:
                                                                random.choice(ABC).cancelGroupInvitation(op.param1,[_mid])                                
                                                        except:
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    if op.param3 not in wait["blacklist"]:
                                                        kj.kickoutFromGroup(op.param1,[op.param2])
                                                        kj.inviteIntoGroup(op.param1,[Zmid])
                                                except:
                                                    try:
                                                        if op.param3 not in wait["blacklist"]:
                                                            km.kickoutFromGroup(op.param1,[op.param2])
                                                        ...
                                                        try:
                                                            ...
                                                            try:
                                                                ...
                                                                try:
                                                                    if op.param3 not in wait["blacklist"]:
                                                                        kz.kickoutFromGroup(op.param1,[op.param2])
                                                                        kz.inviteIntoGroup(op.param1,[Zmid])
                                                                except:
                                                                    pass
                return
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        kj.findAndAddContactsByMid(op.param1,staff)
                                        kj.inviteIntoGroup(op.param1,staff)
                                        kj.kickoutFromGroup(op.param1,[op.param2])
                                    except:
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        kz.findAndAddContactsByMid(op.param1,staff)
                                                        kz.inviteIntoGroup(op.param1,staff)
                                                        kz.kickoutFromGroup(op.param1,[op.param2])
                                                    except:
                                                        pass
                return
               ...
               if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        ...
                        #   cl.sendMessage(msg.to, None, contentMetadata={"STKID":"12860206","STKPKGID":"1318703","STKVER":"1"}, contentType=7)
                           break
               if 'MENTION' in msg.contentMetadata.keys() != None:
               ...
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"Contact itu bukan anggota bot Nadya_TJ")
#ADD STAFF
                 if msg._from in admin:
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     path4 = kg.downloadObjectMsg(msg_id)
                     path5 = kj.downloadObjectMsg(msg_id)
                     path6 = km.downloadObjectMsg(msg_id)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                Setmain["TJfoto"][Emid] = True
                                kj.sendMessage(msg.to,"Kirim fotonya.....")

                        elif cmd == "bot6up":
                            if msg._from in admin:
                                Setmain["TJfoto"][Fmid] = True
                                km.sendMessage(msg.to,"Kirim fotonya.....")

                        elif cmd == "bot7up":
                            if msg._from in admin:
                                Setmain["TJfoto"][Gmid] = True
                                kn.sendMessage(msg.to,"Kirim fotonya.....")

                        elif cmd == "bot8up":
                            if msg._from in admin:
                                Setmain["TJfoto"][Hmid] = True
                                ks.sendMessage(msg.to,"Kirim fotonya.....")

                        elif cmd == "bot9up":
                            if msg._from in admin:
                                Setmain["TJfoto"][Imid] = True
                                kz.sendMessage(msg.to,"Kirim fotonya.....")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kg.sendMessage(msg.to,responsename4)
                                kj.sendMessage(msg.to,responsename5)
                                km.sendMessage(msg.to,responsename6)

                        elif cmd == "ping":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "Ping❦")
                                ki.sendMessage(msg.to, "Ping❦")
                                kk.sendMessage(msg.to, "Ping❦")
                                kc.sendMessage(msg.to, "Ping❦")
                                kg.sendMessage(msg.to, "Ping❦")
                                kj.sendMessage(msg.to, "Ping❦")
                                km.sendMessage(msg.to, "Ping❦")

                        elif cmd == "mybri":
                          if wait["selfbot"] == True:
                            if msg._from in admin:              
                                cl.sendMessage(msg.to, "BRI a/n Usup Saepul Anwar 415701019889535")
                           ...
                           if msg._from in admin:
                              ...
                              if jumlah <= 1000:
                                  for var in range(0,jumlah):
                                      ...
                                      kg.sendMessage(midd, str(Setmain["TJmessage1"]))
                                      kj.sendMessage(midd, str(Setmain["TJmessage1"]))
                                      km.sendMessage(midd, str(Setmain["TJmessage1"]))
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     group4 = kg.findGroupByTicket(ticket_id)
                                     kg.acceptGroupInvitationByTicket(group4.id,ticket_id)
                                     kg.sendMessage(msg.to, "Masuk : %s" % str(group.name))
                                     group5 = kj.findGroupByTicket(ticket_id)
                                     kj.acceptGroupInvitationByTicket(group5.id,ticket_id)
                                     kj.sendMessage(msg.to, "Masuk : %s" % str(group.name))
                                     group6 = km.findGroupByTicket(ticket_id)
                                     km.acceptGroupInvitationByTicket(group6.id,ticket_id)
